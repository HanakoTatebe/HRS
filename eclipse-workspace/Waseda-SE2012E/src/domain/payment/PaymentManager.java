...
public class PaymentManager {
	...
	/**
	 * 新たに追加：部屋番号・金額・チェックアウト日を受け取って支払いを処理
	 */
	public void processPayment(String roomNumber, int amount, Date checkOutDate) throws PaymentException {
		if (roomNumber == null) {
			throw new NullPointerException("roomNumber");
		}
		...
		consumePayment(checkOutDate, roomNumber);
	}
