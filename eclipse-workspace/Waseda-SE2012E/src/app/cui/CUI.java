...
public class CUI {
	...
	private void reserveRoom() throws IOException, AppException {
		...
		// ✅ 空室状況の表示（ReserveRoomForm にメソッドを追加）
		 reserveRoomForm.displayAvailability();

		// ✅ ユーザから部屋種別と数を入力
		System.out.print("Select room type (Single or Double): ");
		...
		reserveRoomForm.setRoomCount(count);
